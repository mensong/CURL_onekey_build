...
devenv %~dp0\build_x64\lib\libcurl.vcxproj /build "Release|x64" /project %~dp0\build_x64\lib\libcurl.vcxproj
mkdir %outDir%\lib\x64\Release
copy /Y %~dp0\..\deps\lib\x64\Release\*.* %outDir%\lib\x64\Release
copy /Y %~dp0\build_x64\lib\Release\libcurl.lib %outDir%\lib\x64\Release\libcurl.lib

rem x64 debug
cd /d %~dp0
copy /Y %~dp0\..\deps\lib\x64\Debug\*.* %~dp0\..\deps\lib\
devenv %~dp0\build_x64\lib\libcurl.vcxproj /build "Debug|x64" /project %~dp0\build_x64\lib\libcurl.vcxproj
mkdir %outDir%\lib\x64\Debug
copy /Y %~dp0\..\deps\lib\x64\Debug\*.* %outDir%\lib\x64\Debug
copy /Y %~dp0\build_x64\lib\Debug\libcurl-d.lib %outDir%\lib\x64\Debug\libcurl.lib
